// Designer OS — Inline SVG icons (Lucide-style, hand-picked)
// Usage: icon('home') -> SVG string
...
const ICONS = {
  ...
  receipt: '<path d="M4 2v20l3-2 3 2 3-2 3 2 3-2V2l-3 2-3-2-3 2-3-2-3 2z"/><line x1="8" y1="9" x2="16" y2="9"/><line x1="8" y1="13" x2="13" y2="13"/>',
  ...
  light: '<path d="M9 18h6M10 22h4"/><path d="M12 2a7 7 0 0 0-4 12.7c.9.7 1.5 1.5 1.5 2.3V18h5v-1c0-.8.6-1.6 1.5-2.3A7 7 0 0 0 12 2z"/>',
  calculator: '<rect x="4" y="2" width="16" height="20" rx="2"/><line x1="8" y1="6" x2="16" y2="6"/><line x1="16" y1="14" x2="16" y2="18"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="8" y1="18" x2="8" y2="18.01"/><line x1="12" y1="18" x2="12" y2="18.01"/>',
  ...
  pin: '<line x1="12" y1="17" x2="12" y2="22"/><path d="M9 17h6l1-7-3-2v-3a2 2 0 1 0-4 0v3l-3 2 1 7"/>',
...
export function icon(name, opts = {}) {
  ...
  return `<svg viewBox="0 0 24 24" width="${size}" height="${size}" fill="none" stroke="currentColor" stroke-width="${sw}" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${path}</svg>`;
}
